...
export class Contract extends ethereum.SmartContract {
  ...
  endAt(): BigInt {
    let result = super.call("endAt", "endAt():(uint256)", []);

    return result[0].toBigInt();
  }

  try_endAt(): ethereum.CallResult<BigInt> {
    let result = super.tryCall("endAt", "endAt():(uint256)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
  ...
  gondola(): Address {
    let result = super.call("gondola", "gondola():(address)", []);

    return result[0].toAddress();
  }

  try_gondola(): ethereum.CallResult<Address> {
    let result = super.tryCall("gondola", "gondola():(address)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
  ...
  gondolaPerSec(): BigInt {
    let result = super.call("gondolaPerSec", "gondolaPerSec():(uint256)", []);

    return result[0].toBigInt();
  }

  try_gondolaPerSec(): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "gondolaPerSec",
      "gondolaPerSec():(uint256)",
      []
    );
    if (result.reverted) {
      return new ethereum.CallResult();
  ...
  pendingGondola(_pid: BigInt, _user: Address): BigInt {
    let result = super.call(
      "pendingGondola",
      "pendingGondola(uint256,address):(uint256)",
      [
